import type {
	DropdownProps as DropdownCProps} from "primereact/dropdown";
import {
...
export const Dropdown = ({ ...props }: DropdownProps) => {
	return (
		<DropdownC
			...
			pt={{
				input: {
					className: "text-[13px] text-black placeholder:text-gray-1000",
				},
				wrapper: { className: "bg-gray-200 rounded-b-lg p-0" },
				list: { className: "p-0" },
				item: {
					className: "text-[13px] bg-gray-200 text-black hover:bg-gray-300",
				},
			}}
