...
export const BorrowerInformation: FC<InvestorBankInfoProps> = ({
	...
	return (
		<div className="flex w-full rounded-2xl gap-5 text-gray-1000 justify-center p-[5px] overflow-hidden mt-9">
			<form
				onSubmit={handleSubmit(onSubmit)}
				className="w-full h-full flex  justify-between gap-7"
			>
				<div className="w-[60%] bg-white border border-gray-200 p-4 rounded-3xl gap-6 flex flex-col ">
					...
					<div className="flex w-full gap-4">
						<div className="w-full">
							<Input
								...
								register={register(borrowerInformationFields?.firstName || "")}
								error={
									errors?.[borrowerInformationFields?.firstName || ""] &&
									errors?.[borrowerInformationFields?.firstName || ""]?.message
								}
							/>
						</div>
						<div className="w-full">
				...
				<div className="w-[40%] bg-white flex gap-6 flex-col overflow-auto border border-gray-200 p-4 rounded-3xl ">
					...
					<Input
						...
						register={register(borrowerInformationFields?.routingNumber || "")}
					/>
					...
					<Input
						...
						register={register(borrowerInformationFields?.accountNumber || "")}
					/>
