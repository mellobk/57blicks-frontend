...
const ArrowDown: React.FC<Props> = ({ color = "#BBBBBB", fill = 'none', width = 48, }: Props) => {
  return (
    <svg width={width} height={width} viewBox="0 0 7 6" fill="none" xmlns="http://www.w3.org/2000/svg">
